<script lang="ts">
	...
	let mediaItems = [
		{
			...
			image: 'otu.svg',
			date: '12/Feb/2026',
			title: 'GOV OTU BACKS UNICAL TO HOST NUGA GAMES',
			description:
				'Governor otu gave this assurance during an inspection tour of facilities at the UJ Esuene Stadium'
		},
		{
			tag: 'Sports',
			image: 'media2.svg',
			date: '10/Feb/2026',
			title: 'NUGA GAMES TO HOLD IN CALABAR IN 2026',
			description:
				'The Nigeria University Games Association (NUGA) has announced that the 2026 edition of the games will be hosted in Calabar, Cross River State.'
		},
		{
			tag: 'Education',
			image: 'media3.svg',
			date: '08/Feb/2026',
			title: 'UNICAL TO HOST NUGA GAMES IN 2026',
			description:
				'The University of Calabar (UNICAL) has been selected as the host for the 2026 Nigeria University Games Association (NUGA) games, marking a significant milestone for the institution and the city of Calabar.'
		},
		{
			tag: 'Sports',
			image: 'media4.svg',
	...
	let videoPreviews = [
		{
			thumbnail: 'media2.svg',
			title: 'NUGA Games 2026 Highlights',
			duration: '3:45',
			date: '12/Feb/2026',
			description: 'Watch the best moments from previous NUGA Games and get excited for 2026'
		},
		{
			thumbnail: 'media3.svg',
			title: 'Governor Otu Visits UNICAL',
			duration: '2:30',
			date: '10/Feb/2026',
			description: 'Governor Otu inspects facilities ahead of the upcoming games in Calabar'
		},
		{
			thumbnail: 'media4.svg',
			title: 'Opening Ceremony Preview',
			duration: '5:12',
			date: '08/Feb/2026',
			description: 'A sneak peek at what to expect during the grand opening ceremony'
		},
		{
			thumbnail: 'otu.svg',
			...
			duration: '4:18',
			date: '05/Feb/2026',
			description: 'Take a tour of the world-class sports facilities at UNICAL'
		}
	];
...
<section class="py-12 sm:py-16 lg:py-24 relative">
	...
	>
		...
		<div class="relative z-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
			...
			<div class="lg:col-span-2 media-font">
				<div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
					{#each mediaItems as item}
						<div class="bg-white/30 p-3 rounded-xl">
							<article
								class="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 group"
							>
				...
				<div class="flex items-center justify-center gap-2 mt-8">
					<button
						...
						class="p-2 rounded-full bg-white/20 text-white hover:bg-white/30 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
					>
						<svg
					...
					{#each Array(totalPages) as _, i}
						<button
							...
							class="w-10 h-10 rounded-full flex items-center justify-center font-semibold transition-colors {currentPage ===
							i + 1
			...
			<div class="hidden lg:flex lg:col-span-1 flex-col justify-center">
				<div class="text-right">
					<p class="text-white text-lg sm:text-xl lg:text-2xl font-medium mb-6">
				...
				<!-- Explore button -->
				<div
					class="items-center justify-center mt-5 w-fit mx-auto lg:mx-0 lg:ml-auto bg-gray-200/20 backdrop-blur-md rounded-full px-4 py-2 md:px-8 shadow-lg"
				>
					<button
	...
	<section
		class="bg-gradient-to-b from-gray-400 to-blue-950 rounded-b-3xl p-6 sm:p-8 lg:p-12 relative overflow-hidden"
	>
		<h2 class="text-white font-bold text-2xl lg:text-3xl mb-8 flex flex-col">
			Latest <p class="inline-block">
				<span>Videos</span> <img src="/brush.svg" class="h-6 w-24 -mt-3" alt="" />
			</p>
		</h2>

		<div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:px-12 items-start">
			<!-- Left: YouTube Video Frame - styled like mediaItems -->
			<div class="bg-white/30 p-3 rounded-xl mx-auto w-full">
				<article
					class="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 group"
				>
					<div class="relative overflow-hidden">
						...
						<span
							class="absolute top-4 left-4 bg-red-600 text-white text-xs sm:text-sm font-semibold px-3 py-1 rounded-full"
						>
							Featured
						</span>
					</div>
			...
			<div class="media-font p-3 bg-white/30 rounded-xl mx-auto w-full max-w-xl">
				<div class="grid grid-cols-1 gap-4 bg-white p-3 rounded-xl">
		...
		<div
			class="flex flex-col sm:flex-row gap-4 mt-5 items-center justify-between max-w-6xl mx-auto"
		>
			<p class="text-white text-lg sm:text-xl">Be the first to know when we upload a new video</p>

			<div class="flex flex-col sm:flex-row items-center gap-8">
				<svg
					class="text-white w-12 h-12 hidden sm:flex"
					xmlns="http://www.w3.org/2000/svg"
					width="24"
					height="24"
					viewBox="0 0 24 24"
				...
				<!-- youtube button -->
				<div
					class="items-center justify-center mt-5 w-fit mx-auto lg:mx-0 lg:ml-auto bg-gray-200/20 backdrop-blur-md rounded-full px-4 py-2 shadow-lg"
				>
					<button
				...
				>
					<button
						class="flex items-center gap-2 bg-gradient-to-b from-gray-200 to-green-200 text-black px-6 lg:px-8 py-3 lg:py-5 rounded-full font-semibold text-base lg:text-lg hover:scale-105 transition-transform shadow-md"
					>
						Get Involved
					</button>
				</div>

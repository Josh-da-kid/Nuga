...
<section class="py-10 sm:py-12 lg:py-16 xl:py-24 relative">
	...
	>
		<div class="items-start justify-start mx-auto flex flex-col px-4 md:px-8 lg:px-12">
			<h2 class="text-white font-bold text-2xl lg:text-4xl xl:text-5xl mb-8 flex flex-col">
		...
		<div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:px-12 items-stretch">
			...
			<div class="flex flex-col w-full h-full">
				...
				<div class="block md:flex text-center items-center justify-between mt-4 lg:mt-8 px-2">
					...
					<svg
						class="text-white w-8 h-8 flex-shrink-0 items-center flex justify-center mx-auto md:mx-0"
						xmlns="http://www.w3.org/2000/svg"
						width="24"
						height="24"
						viewBox="0 0 24 24"
